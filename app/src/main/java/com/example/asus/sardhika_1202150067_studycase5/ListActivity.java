...
public class ListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list); setTitle("To Do List");
    ...
    public void hapusswipe(){
        ...
        ItemTouchHelper.SimpleCallback touchcall = new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT) {
            ...
            public void onSwiped(RecyclerView.ViewHolder viewHolder, int direction) {
                ...
                add current = adapter.getData(position);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menuto, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id==R.id.action_settings){
            ...
            Intent intent = new Intent(ListActivity.this, setting.class);
            //memulai intent
    ...
    public void add(View view) {
        ...
        Intent intent = new Intent(ListActivity.this, addto.class);
        //memulai intent
        startActivity(intent);
    }
}